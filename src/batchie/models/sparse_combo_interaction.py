...
from batchie.core import BayesianModelParams, ModelParamsHolder
...
@dataclass
class SparseDrugComboInteractionMCMCSample(BayesianModelParams):
...
class SparseDrugComboInteractionResults(ModelParamsHolder):
    def __init__(
        self,
